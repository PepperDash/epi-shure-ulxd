...
namespace epi_mics_shure_ulxd
{
    public class ShureUlxMicDevice : EssentialsBridgeableDevice, IDeviceInfoProvider
    {
                ...
                base(key, name)
        {
            ...
            _props = JsonConvert.DeserializeObject<ShureUlxMicDeviceProperties>(_dc.Properties.ToString());
            ...
            Debug.Console(1, this, "Made it to consturctor for Shure ULX {0}", Name);
            Debug.Console(2, this, "Shure ULX Properties : {0}", _dc.Properties.ToString());
